# receipt-parser - Infrastructure as code
...
```
curl "https://nubesgen.com/receipt-parser.zip?iactool=BICEP&region=westeurope&application=FUNCTION.consumption&runtime=PYTHON&database=NONE.serverless&addons=application_insights&gitops=true" | tar -xzvf -
```
